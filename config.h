/* Version 0.8-dev. Patches applied - bar, alwayscenter, swallow, gaps, naturalscrolltrackpad, regions, nextlayout, barpadding,minimizexwayland,rlimit,movestack */
...
static const float rootcolor[] = COLOR(0x181616ff); /* Adapted to dangion background */
...
static uint32_t colors[][3] = {
    /*               fg             bg             border      */
    [SchemeNorm] = {0xc5c9c5ff, 0x181616ff, 0x0d0c0cff}, /* fg=#c5c9c5, bg=#181616, border=#0d0c0c */
    [SchemeSel] = {0xc5c9c5ff, 0x2d4f67ff, 0x7FB4CAff},  /* fg=#c5c9c5, bg=#2d4f67, border=#7FB4CA */
    [SchemeUrg] = {0xc5c9c5ff, 0x181616ff, 0x7FB4CAff},  /* fg=#c5c9c5, bg=#181616, border=#7FB4CA */
};

//
// static uint32_t colors[][3] = {
//     /*               fg             bg             border      */
//     [SchemeNorm] = {0xc5c9c5ff, 0x1e1e1eff, 0x121212ff},
//     [SchemeSel]  = {0xd4be98ff, 0x5c6370ff, 0x61afefff},
//     [SchemeUrg]  = {0xc5c9c5ff, 0x1e1e1eff, 0xe06c75ff},
// };
...
static const Rule rules[] = {
    ...
    {"zen-bin", NULL, 1 << 0, 0, 0, 0, -1}, /* Start on ONLY tag "9" */
};
...
static const MonitorRule monrules[] = {
    ...
    *  	/* defaults */
    // {NULL, 0.55f, 1, 1, &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL, -1, -1, 1920, 1080, 143.981f, -1, 1},
...
static const char *menucmd[] = {
    "mew-run",
    // "-fn", "JetBrains Mono:style=Regular:pixelsize=11:antialias=true:autohint=true",
    // "-nb", "#181616",
    // "-nf", "#c5c9c5",
    // "-sb", "#7FB4CA",
    // "-sf", "#C8C093",
...
static const Key keys[] = {
    ...
    {0, XKB_KEY_Print, spawn, {.v = flameshot}},

    {MODKEY | SHIFT, XKB_KEY_space, togglefloating, {0}},
    {MODKEY, XKB_KEY_e, togglefullscreen, {0}},
    {MODKEY | SHIFT, XKB_KEY_m, toggleswallow, {0}},
